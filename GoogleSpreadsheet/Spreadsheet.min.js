...
$(this).text(),"none"==c.sign)$(this).html(Math.abs(a).toFixed(c.decimals));else if("minus"!=c.sign)if("plusMinus"==c.sign)0<parseFloat(a)&&$(this).html("+"+a);else if("parentheses"==c.sign)0>parseFloat(a)&&$(this).html("("+Math.abs(a).toFixed(c.decimals)+")");else if("arrow"==c.sign){var b=$("<img class='arrow'>");b.height($(this).height());$(this).html(Math.abs(a).toFixed(c.decimals));0>parseFloat(a)?b.attr("src","//s3.amazonaws.com/risecontentlogos/financial/animated-red-arrow.gif"):0<=parseFloat(a)&&
b.attr("src","//s3.amazonaws.com/risecontentlogos/financial/animated-green-arrow.gif");$(this).prepend(b)}}))}})};RiseVision.Spreadsheet.prototype.setFontSizes=function(){var a=parseInt($(".heading_font-style").css("font-size")),b=parseInt($(".data_font-style").css("font-size")),a=a/16,b=b/16;$(".heading_font-style").css("font-size",a+"em");$(".data_font-style, .tableMenuButton").css("font-size",b+"em")};
