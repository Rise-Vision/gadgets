...
Date.today(),k=0;k<this.collectionTimes.length;k++)this.collectionTimes[k].startTime.addDays(1),this.collectionTimes[k].endTime.addDays(1);(k=this.helper.getInstruments(this.isLoading,this.collectionTimes))?(e=this,k={url:this.url+"id="+this.displayID+"&codes="+encodeURIComponent(k),refreshInterval:0,queryString:g,callback:function(a){e.onRealTimeDataLoaded(a,c,b)}},this.getDataTimer=setTimeout(function(){e.getData(a,c,b,d)},this.updateInterval),this.viz.getData(k)):d(null)};
...
RiseVision.Common.Utility.scaleToFit=function(a){var c=new Image;c.onload=function(){var b,d,e,f;b=c.width;d=c.height;0<b&&0<d&&(b>a.rsW||d>a.rsH)&&(e=a.rsW/b,f=a.rsH/d,e=e<f?e:f,b=parseInt(b*e,10),d=parseInt(d*e,10));a.callback(b,d)};c.onerror=function(){a.onerror(c)};c.setAttribute("src",a.url)};RiseVision.Common.Utility.getNodeValue=function(a){return null!=a&&0<a.length?a[0].textContent:""};
